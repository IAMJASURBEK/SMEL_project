...
```
Now, let’s take a look at the material tag. [Source: 04-materials.urdf]:
```
<?xml version="1.0"?>
...
Finally, I will finish the model off with a few more shapes: feet, wheels, and head. Most notably, I will add a sphere and a some meshes. I will also add few other pieces that I will use later. [Source: 05-visual.urdf]:
```
<?xml version="1.0"?>
<robot name="visual">
